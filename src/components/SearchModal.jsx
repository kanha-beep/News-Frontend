      ...
      <div className="w-full max-w-xl rounded-2xl bg-white p-4 shadow-xl">
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-600">
              {uiLabels?.searchNews || "Search news"}
            </p>
            <h2 className="mt-2 text-lg font-bold text-slate-900">
              {uiLabels?.filterByTitleAndDate || "Filter by title and date"}
            </h2>
          </div>
          <button
            type="button"
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              {uiLabels?.searchHeadlineText || "Search headline text"}
            </label>
            <input
              ...
              placeholder={uiLabels?.searchHeadlinePlaceholder || "Search headline text..."}
          ...
          <div>
            <label
              ...
              className="mb-2 block text-sm font-semibold text-slate-700"
            >
              {uiLabels?.filterByDate || "Filter by date"}
            </label>
            <input
