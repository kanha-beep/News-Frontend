...
export const DEFAULT_UI_LABELS = {
  ...
  showLatestNews: "Show latest news",
  decreaseTextSize: "Decrease text size",
  increaseTextSize: "Increase text size",
  searchNews: "Search news",
  filterByTitleAndDate: "Filter by title and date",
  close: "Close",
  searchHeadlineText: "Search headline text",
  searchHeadlinePlaceholder: "Search headline text...",
  ...
  createTopicAlert: "Create a topic alert",
  alertExamplePlaceholder: "Example: kerala rain",
  topicAlert: "Topic alert",
  breakingAlert: "Breaking alert",
  saving: "Saving...",
  createAlert: "Create alert",
  pushNotifications: "Push notifications",
  savedAlertDelivery: "Saved alert delivery",
  notificationsEnabled: "Notifications are enabled for this browser.",
  ...
  noPushSupport: "This browser does not support web push notifications.",
  working: "Working...",
  ...
  latest: "Latest",
  noMatchingStoryYet: "No matching story yet",
  pause: "Pause",
  enable: "Enable",
  delete: "Delete",
};
